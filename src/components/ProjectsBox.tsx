    ...
    return (
        <div className="flex items-stretch gap-2 h-full">
            <img
                ...
                alt="Pattern"
                className="flex-none w-[12vh] h-full rounded-md filter grayscale dark:brightness-50 dark:contrast-125 dark:hover:grayscale-0 dark:hover:brightness-70 hover:grayscale-0 transition duration-300"
            />
